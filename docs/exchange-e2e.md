...
- Final database state has zero E2E `EXCHANGE` wallet balances, wallet transaction counts of `85 DEPOSIT`, `81 ORDER_CREATE`, `49 ORDER_CANCEL`, `46 TRADE`, `46 FEE`, and `1 ORDER_FINALIZED`, processed Accountant financial action counts of `81 SubmitOrderEvent`, `42 CancelOrderEvent`, `4 RejectOrderEvent`, `93 TradeEvent`, and `3 UpdatedOrderEvent`, no pending/given-up Accountant retries, zero Market `open_orders`, internally consistent Market trade rows, and the same persisted trade distribution as the public recent-trades API.
